...
def t5_tokenize(texts: List[str], name=DEFAULT_T5_NAME, device: str = "cuda"):
    ...
    # Move input_ids and attention_mask to the same device
...
def t5_encode_text(
    texts: List[str], name=DEFAULT_T5_NAME, return_attn_mask=False, device="cuda"
):
