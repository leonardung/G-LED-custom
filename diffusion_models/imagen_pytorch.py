...
from diffusion_models.imagen_video import Unet3D, resize_video_to
...
class Imagen(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.encode_text = partial(t5_encode_text, name=text_encoder_name, device=device)
